...
export const APP_ROUTES = {
  ...
  inboundRequestDetail: (inboundRequestId: string) => `/inbound-requests/${inboundRequestId}`,
  inboundRequestEdit: (inboundRequestId: string) => `/inbound-requests/${inboundRequestId}/edit`,
  inbound: '/inbound',
  goodsReceipts: '/inbound/receipts',
  ...
  inventoryDamageCases: '/inventory/damage-cases',
