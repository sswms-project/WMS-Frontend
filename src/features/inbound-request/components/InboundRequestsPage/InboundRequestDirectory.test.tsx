...
const inboundRequest: InboundRequestSummary = {
  id: 'af859ca6-dc0f-42ee-9eb3-08df01a537f2',
  inboundRequestCode: 'PO-20260824060202-6F928636-EXTRA-LONG-IDENTIFIER',
...
describe('InboundRequestDirectory', () => {
  it('contains long PO identifiers within the desktop table cell', () => {
    ...
    const poLink = within(table).getByRole('link', { name: inboundRequest.inboundRequestCode })
