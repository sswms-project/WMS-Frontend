...
import { OutboundWorkspaceNavigation } from './OutboundWorkspaceNavigation'

const permissions = ['outbound-orders:view', 'returns:view', 'deliveries:view']

describe('OutboundWorkspaceNavigation', () => {
  it('shows the current view as a distinct filled navigation item', () => {
    render(<OutboundWorkspaceNavigation currentView="returns" permissions={permissions} />)
