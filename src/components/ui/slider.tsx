  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className="bg-muted relative grow overflow-hidden rounded-none data-[orientation=horizontal]:h-1 data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-1"
      >
